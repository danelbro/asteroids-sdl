...
asteroids: obj/asteroids.o obj/DrawWrapLine.o obj/Engine.o obj/Entity.o obj/GameLoop.o obj/Gun.o obj/Hyperdrive.o obj/PhysicsComponent.o obj/Player.o obj/Ship.o obj/utility.o obj/Vec2d.o
	$(CC) $(LDFLAGS) -o asteroids_2 obj/asteroids.o obj/DrawWrapLine.o obj/Engine.o obj/Entity.o obj/GameLoop.o obj/Gun.o obj/Hyperdrive.o obj/PhysicsComponent.o obj/Player.o obj/Ship.o obj/utility.o obj/Vec2d.o $(SDL_LDFLAGS) $(LDLIBS)
